...
test("fromTransform: behavior equals scale->rotate->translate applied to apoint", () => {
...
test("multiply: black-box property using points (A*B acting like A afterB)", () => {
...
test("randomized sanity: transformPoint matches manual steps for manydeterministic cases", () => {
 for (let i = 0; i < 30; i++) {
 const tx = (i % 7) - 3;
 const ty = ((i * 3) % 11) - 5;
